...
Команды в чате: `/reset` — начать новый диалог, `/quit` — завершить. По умолчанию выводится только видимая реплика клиента; для оценочного сигнала добавьте `--show-signal`:
